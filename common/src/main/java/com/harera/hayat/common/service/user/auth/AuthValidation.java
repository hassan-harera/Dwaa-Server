package com.harera.hayat.common.service.user.auth;

import static com.harera.hayat.common.util.ErrorCode.FORMAT_FIRST_NAME;
import static com.harera.hayat.common.util.ErrorCode.FORMAT_LAST_NAME;
import static com.harera.hayat.common.util.ErrorCode.FORMAT_LOGIN_SUBJECT;
import static com.harera.hayat.common.util.ErrorCode.FORMAT_USER_MOBILE;
import static com.harera.hayat.common.util.ErrorCode.INVALID_FIREBASE_TOKEN;
import static com.harera.hayat.common.util.ErrorCode.MANDATORY_FIRST_NAME;
import static com.harera.hayat.common.util.ErrorCode.MANDATORY_LAST_NAME;
import static com.harera.hayat.common.util.ErrorCode.MANDATORY_LOGIN_OAUTH_TOKEN;
import static com.harera.hayat.common.util.ErrorCode.MANDATORY_LOGIN_PASSWORD;
import static com.harera.hayat.common.util.ErrorCode.MANDATORY_LOGIN_SUBJECT;
import static com.harera.hayat.common.util.ErrorCode.MANDATORY_SIGNUP_FIREBASE_TOKEN;
import static com.harera.hayat.common.util.ErrorCode.MANDATORY_USER_MOBILE;
import static com.harera.hayat.common.util.ErrorCode.NOT_FOUND_USERNAME_OR_PASSWORD;
import static com.harera.hayat.common.util.ErrorCode.UNIQUE_EMAIL;
import static com.harera.hayat.common.util.ErrorCode.UNIQUE_SIGNUP_EMAIL;
import static com.harera.hayat.common.util.ErrorCode.UNIQUE_SIGNUP_MOBILE;
import static com.harera.hayat.common.util.ErrorCode.UNIQUE_USER_MOBILE;
import static com.harera.hayat.common.util.ErrorMessage.INCORRECT_USERNAME_PASSWORD_MESSAGE;
import static com.harera.hayat.common.util.HayatStringUtils.isValidEmail;
import static com.harera.hayat.common.util.SubjectUtils.getSubject;
...
import com.harera.hayat.common.model.user.auth.LoginRequest;
import com.harera.hayat.common.model.user.auth.OAuthLoginRequest;
import com.harera.hayat.common.model.user.auth.SignupRequest;
import com.harera.hayat.common.repository.UserRepository;
import com.harera.hayat.common.service.firebase.FirebaseService;
