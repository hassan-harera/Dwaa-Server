package com.harera.hayat.gateway.authorization.config;
...
import com.harera.hayat.common.model.exception.ApiError;
import com.harera.hayat.common.model.exception.GlobalMessage;
import com.harera.hayat.common.repository.GlobalMessageRepository;
import com.harera.hayat.gateway.authorization.filter.JwtRequestFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        final String[] publicUris = { "/api/v1/login", "/api/v1/oauth/**",
                ...
                "/swagger-resources/**", "/actuator/health", "/actuator/info",
                "/actuator/prometheus" };
